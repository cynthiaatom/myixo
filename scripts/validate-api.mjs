...
const unsafeLog=/console\.(?:log|info|warn|error)\([^\n]*(?:prompt|memory|decision|question|desired_outcome|assumptions)/i;
...
console.log(`API VALIDATION PASS: ${files.length} executable /api modules parsed and imported; privacy/static gates passed.`);
