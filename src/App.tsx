...
export default function App(){
  ...
  const disconnect=async()=>{
    ...
    setUser(null);setSession(null);setMemory(null);setNativeContext(null);setEmail('');setPassword('');setModel(demoPersonalMap());setStage('hero');
  };
